"""
Random Forest model training script for music genre classification.
...
def main():
    ...
    setup_logging(
        log_file=f"{config['paths']['logs']}/train_rf.log",
    ...
    model_path = f"{config['paths']['models']}/rf.pkl"
    scaler_path = f"{config['paths']['models']}/rf_scaler.pkl"
    results_path = f"{config['paths']['outputs']}/rf_results.json"
    cm_plot_path = f"{config['paths']['plots']}/rf_confusion_matrix.png"
